...
export const KEEP_RECENT_MESSAGES_AFTER_COMPACTION = 12;
export const MAX_COMPACTION_SUMMARY_LINES = 80;
export const MAX_COMPACTION_SUMMARY_CHARS = 12000;
export const AUTO_COMPACTION_TRIGGER_ESTIMATED_TOKENS = 28000;
